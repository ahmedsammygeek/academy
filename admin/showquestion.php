...
<section class="content">             
  ...
  <div class="row">
      ...
      <div class="box">
        ...
        <table class="table table-hover">
          ...
          while ($result=$query->fetch(PDO::FETCH_ASSOC)) {
           ...
           <td>$question</td>
           <td>$answer</td>
           <td><a href='deletequestion.php?msg=$id' class='btn btn-danger btn-sm'>DELETE</a>
           <a href='editquestion.php?id=$id' class='btn btn-warning btn-sm'>update</a>
   ...
   <a href="question.php"> <button class="btn btn-success btn-lg">add new question</button></a>
