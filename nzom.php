...
<div id="content" class="boxed-page">
	<div class="container">
		<div class="big-title text-center animated fadeInDown delay-01.5" data-animation="fadeInDown" data-animation-delay="01">
			<h1>Management Information Systems <strong>Department</strong></h1>
		</div>

		<p class="text-center">Sed ut perspiciatis unde omnis iste natus error sit voluptatem , totam rem aperiam, eaque ipsa quae ab illo inventore
			...
			<div class="row">
				<div class="col-md-6">
					<h4 class="classic-title"><span>Management Information Systems subjects</span></h4>
				</div>
			</div>
			<div class="row">
				<!-- start of col-md-6 -->
				...
				<div class="col-md-6">
					...
					<div class="panel-group" id="accordion">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-26" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-27" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-28" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-29" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-30" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-31" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-32" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-33" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
				...
				<div class="col-md-6">
					...
					<div class="panel-group" id="accordion">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-34" class="collapsed">
										<i class="fa fa-angle-up control-icon"></i>
										<i class="fa fa-desktop"></i> Fully Responsive Theme
									</a>
								</h4>
							</div>
							<div id="collapse-34" class="panel-collapse collapse" style="height: 0px;">
								<div class="panel-body">Duis ute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like <strong>readable English</strong>. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore...</div>
							</div>
						</div>
						<!-- End Accordion 1 -->
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-35" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-gift"></i> Touchable Slider
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-36" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-37" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
							</div>
							<div id="collapse-37" class="panel-collapse collapse" style="height: 0px;">
								<div class="panel-body"><strong>Duis</strong> aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore...</div>
							</div>
						</div>
						<!-- End Accordion 3 -->
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-38" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-39" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-40" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-41" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-42" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#accordion" href="#collapse-43" class="collapsed">
										<i class="fa fa-angle-down control-icon"></i>
										<i class="fa fa-tint"></i> Retina Ready
									</a>
								</h4>
